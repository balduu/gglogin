...
function getDayString(lunar, solarDay, solarMonth, solarYear) {
	...
	*/
	...
	else if (lunar.day == 10 && lunar.month == 3) {
		s += " Giỗ Tổ Hùng Vương";
	}
	
	else {
		if (solarDay == 2 && solarMonth == 9) {
			s += " Ngày Quốc Khánh Việt Nam";
		}
		s += " tức ngày ";
		s = s + lunar.day+" th\341ng "+lunar.month;
		if (lunar.leap == 1) {
			s = s + " nhu\u1EADn";
		}
	}
...
var DAYNAMES = new Array("日", "月", "火", "水", "木", "金", "土");
...
function getPrevYearLink(mm, yy) {
	...
	return '<a class = "changeYear" href="'+window.location.pathname+'?yy='+(yy-1)+'&mm='+mm+'">&lt;&lt;</a>';
}
...
function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	...
	if (solarDate == 1 && solarMonth == 1) {
		cellClass = "tet2";
	}
	if (solarDate == 2 && solarMonth == 9) {
		cellClass = "tet";
	}
	if (solarDate == 30 && solarMonth == 4) {
		cellClass = "tet2";
	}
	if (solarDate == 1 && solarMonth == 5) {
		cellClass = "tet2";
	}
	if (lunarDate.leap == 1) {
		lunarClass = "am2";
